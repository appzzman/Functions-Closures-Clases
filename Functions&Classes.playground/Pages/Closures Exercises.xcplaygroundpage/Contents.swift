...
var numbers = [9,5,7,6,2]
var k = numbers.sort({ return $0 > $1 })
...
var sum3 = numbers.reduce(0) {(sum, element) in sum + element } // 15

//Changing return type
var r = numbers.reduce(0) {(sum, element)->Double in
    var newsum = sum + Double(element)
    return Double(newsum) / Double(element)
}
